...
final class AdmonitionParser extends AbstractBlockContinueParser implements BlockContinueParserWithInlinesInterface
{
    ...
    public static function blockStartParser(array $config): BlockStartParserInterface
    {
        return new class($config) implements BlockStartParserInterface {
            ...
            public function tryStart(Cursor $cursor, MarkdownParserStateInterface $parserState): ?BlockStart
            {
                ...
                $regex = '/::: ([a-z]+)(?: "(.*)")?\s*$/m';
                $result = preg_match($regex, $rest, $matches);
